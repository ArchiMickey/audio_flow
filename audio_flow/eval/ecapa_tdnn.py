# Copied from ArchiTTS architts/eval/ecapa_tdnn.py for local evaluation.
...
class SERes2Block(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding, dilation, scale, se_bottleneck_dim):
        super().__init__()
        self.conv1 = Conv1dReluBn(in_channels, out_channels, kernel_size=1, stride=1, padding=0)
        self.res2conv = Res2Conv1dReluBn(out_channels, kernel_size, stride, padding, dilation, scale=scale)
        self.conv2 = Conv1dReluBn(out_channels, out_channels, kernel_size=1, stride=1, padding=0)
